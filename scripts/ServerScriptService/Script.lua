...
function GUI:init()
	...
	scanBtn.Position = UDim2.new(0, 468, 0, 7)
	...
	conf.Position = UDim2.new(0, 498, 0, 7)
...
for _, svc in ipairs(SCAN_SERVICES) do state.scanMask[svc.name] = true end
...
local function injectPartes(partes)
	-- Recria Parts no Workspace a partir do metadata
